-- Catalog phase: all threads that have at least one submission (exclude trainee drafts).
  ...
  with base as (
    ...
    where
      ...
      and (
        ...
        or (v_phase = 'not_draft' and lrs.id is not null)
        or (
          v_phase = 'done'
        ...
        or (
          v_phase not in ('all', 'draft', 'done', 'not_draft')
          and lrs.id is not null
