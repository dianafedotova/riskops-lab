...
-- Align with public.users policy "users_select": trainees may read all simulator users
-- (OR public.is_trainee()), so linked-account rows should not be scoped tighter by link.organization_id.
