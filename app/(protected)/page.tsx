    ...
    <div className="space-y-4">
      <section className="page-panel surface-lift p-4 sm:p-6">
        <div className="flex flex-col gap-4 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between">
          ...
          <div className="flex w-full flex-wrap items-center gap-2 sm:w-auto">
            ...
            <Link
              href="/alerts"
              className="inline-flex min-h-11 min-w-[44px] items-center justify-center rounded-md border border-slate-300 bg-slate-100 px-4 py-2 text-sm font-medium text-slate-800 transition-colors duration-150 hover:bg-slate-200 sm:min-h-0 sm:px-3 sm:py-1.5"
            >
              Open Alerts
            </Link>
          </div>
      ...
      <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        {metricCards.map((card) => (
          <article
            key={card.title}
            className="surface-lift rounded-xl border border-slate-300 bg-slate-50 p-5 shadow-[0_8px_18px_rgba(15,23,42,0.09)] transition-shadow duration-150"
          >
      ...
      <section className="grid gap-4 xl:grid-cols-2">
        <article className="surface-lift rounded-xl border border-slate-300 bg-slate-100 p-5 shadow-[0_8px_18px_rgba(15,23,42,0.08)] transition-shadow duration-150">
        ...
        <article className="surface-lift rounded-xl border border-slate-300 bg-slate-100 p-5 shadow-[0_8px_18px_rgba(15,23,42,0.08)] transition-shadow duration-150">
          ...
          <div className="mt-3 flex flex-wrap gap-2">
            <Link
              href="/guide"
              className="rounded-md border border-slate-300 bg-slate-50 px-2.5 py-1.5 text-sm text-slate-700 transition-colors duration-150 hover:bg-slate-200"
            >
              Open Guide
            </Link>
            <Link
