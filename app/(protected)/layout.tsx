...
import { ProtectedMarketingExitGuard } from "@/components/protected-marketing-exit-guard";
...
export default async function ProtectedLayout({
  ...
  return (
    <CurrentUserProvider initialSession={{ authUser, appUser }}>
      <ProtectedMarketingExitGuard />
