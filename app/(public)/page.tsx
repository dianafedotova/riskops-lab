...
export default function LandingPage() {
  ...
  const secondaryButtonClass =
    "inline-flex min-h-11 items-center justify-center rounded-lg bg-white/95 px-4 py-2 text-sm font-semibold text-slate-800 shadow-sm transition-all duration-150 hover:-translate-y-0.5 hover:bg-white sm:min-h-0 sm:px-4 sm:py-2";
  const cardClass =
    "surface-lift rounded-2xl bg-slate-50 p-6 shadow-[0_12px_26px_rgba(15,23,42,0.10)]";
    ...
    <div className="main-content-shell p-3 sm:p-5 md:p-6">
      <div className="space-y-6">
        ...
        <div className="relative grid gap-6 lg:grid-cols-[1.2fr_0.8fr] lg:items-end">
          ...
          <aside className="rounded-2xl bg-white/90 p-4 shadow-[0_12px_24px_rgba(15,23,42,0.10)] backdrop-blur">
        ...
        <section className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-[#264B5A] to-[#315E70] p-6 shadow-[0_16px_30px_rgba(2,6,23,0.25)]">
        <div
          aria-hidden="true"
